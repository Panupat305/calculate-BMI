...
const App: React.FC = () => {
  ...
  const calculateBMI = () => {
    ...
    const weightConversionFator = calcUnits === 'ftlbs' ? 2.2 : 1;
    const heightConversionFator = calcUnits === 'ftlbs' ? 3.28 : 1;

    const weight = +enteredWeight / weightConversionFator;
    const height = +enteredHeight / heightConversionFator;
